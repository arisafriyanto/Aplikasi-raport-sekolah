												...
												<ul style="float: right;" class="pagination">
													...
													<?php 
														...
														if($page > 1) {
															...
															$link = $page -1;
															echo "<li class='page-item'><a class='page-link' href='?page=laporannilai&hal=$link'>&laquo; Previous</a></li>";
														...
														for ($i=1; $i <=$halaman ; $i++) { 
															if($i != $page) {
															echo "<li class='page-item'><a class='page-link' href='?page=laporannilai&hal=$i' >$i</a></li>";
															}else{
																echo "<li class='page-item active'><a class='page-link' href='?page=laporannilai&hal=$i' >$i</a></li>";
															}
														}
														...
														if($page < $halaman) {
															$link = $page + 1;
															echo "<li class='page-item'><a class='page-link' href='?page=laporannilai&hal=$link'>Next &raquo;</a></li>";
														}else{
