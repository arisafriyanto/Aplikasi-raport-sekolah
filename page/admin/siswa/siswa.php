					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="card">
							<h5 class="card-header">
								<a href="?page=siswa&action=insert" class="btn btn-rounded btn-info btn-sm">
								...
								<div style="float: right; padding-top: 10px" class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
									<form action="" method="post">
										...
										<input class="form-control" type="text" name="keyword" placeholder="Search.." id="cari">
								...
								<table class="table table-striped">
									...
									<?php 
										...
										$result = tampil("select * from siswa order by nama_siswa asc limit $start, $perpage ");
										$no = $start + 1;
												...
												<ul style="float: right;" class="pagination">
													...
													<?php 
														...
														if($page > 1) {
															...
															$link = $page -1;
															echo "<li class='page-item'><a class='page-link' href='?page=siswa&hal=$link'>&laquo; Previous</a></li>";
														...
														for ($i=1; $i <=$halaman ; $i++) { 
															if($i != $page) {
															echo "<li class='page-item'><a class='page-link' href='?page=siswa&hal=$i' >$i</a></li>";
															}else{
																echo "<li class='page-item active'><a class='page-link' href='?page=siswa&hal=$i' >$i</a></li>";
															}
														}
														...
														if($page < $halaman) {
															$link = $page + 1;
															echo "<li class='page-item'><a class='page-link' href='?page=siswa&hal=$link'>Next &raquo;</a></li>";
														}else{
