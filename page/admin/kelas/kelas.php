					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="card">
							<h5 class="card-header">
								<a href="?page=kelas&action=insert" class="btn btn-rounded btn-secondary btn-sm">
								...
								<div style="float: right; padding-top: 10px" class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
									<form action="" method="post">
										...
										<input class="form-control" type="text" name="cari_kelas" placeholder="Search.." id="cari_kelas">
								...
								<table class="table table-striped">
									...
									<?php 
										...
										$result = tampil("select * from kelas order by kode_kelas asc limit $start, $perpage ");
										$no = $start + 1;
												...
												<ul style="float: right;" class="pagination">
													...
													<?php 
														...
														if($page > 1) {
															...
															$link = $page -1;
															echo "<li class='page-item'><a class='page-link' href='?page=kelas&hal=$link'>&laquo; Previous</a></li>";
														...
														for ($i=1; $i <=$halaman ; $i++) { 
															if($i != $page) {
															echo "<li class='page-item'><a class='page-link' href='?page=kelas&hal=$i' >$i</a></li>";
															}else{
																echo "<li class='page-item active'><a class='page-link' href='?page=kelas&hal=$i' >$i</a></li>";
															}
														}
														...
														if($page < $halaman) {
															$link = $page + 1;
															echo "<li class='page-item'><a class='page-link' href='?page=kelas&hal=$link'>Next &raquo;</a></li>";
														}else{
